...
export const MOCK_FEEDBACK_TEMPLATES: Record<QuestionType, MockFeedbackTemplate> = {
  description: {
    ...
    coreSentences: [
      'I would like to describe {topic} in my daily life.', 'It is one of the places I know best because I visit it regularly.', 'The area is easy to find and convenient to visit without making a special plan.', 'Inside, the layout is simple and well organized for first-time visitors.', 'There are several useful facilities for visitors who want to spend time comfortably.', 'The atmosphere is usually calm and welcoming even when several people are around.', 'I often go there when I need a comfortable break after a busy part of my day.', 'I especially like small details such as the colors and decorations in the space.', 'They make the place feel more personal and memorable.', 'That is why {topic} is special to me, and I always enjoy returning there.',
    ],
    nextSentences: [
      'I would like to tell you about {topic}, which is one of my favorite places in my area.', 'The first thing people notice is its welcoming atmosphere.', 'The space has a well-designed layout, so it is easy to move around even on a first visit.', 'There are useful facilities in every part of the place.', 'The lighting and colors make the interior feel comfortable.', 'It can become lively, but it rarely feels confusing.', 'I normally visit when I want to take a break from my routine and reset my mood.', 'Sometimes I meet friends there, and sometimes I go alone.', 'Either way, I can spend time at my own pace.', 'I also appreciate how clean and well maintained it is.', 'Those practical details make every visit enjoyable.', 'For these reasons, I would gladly recommend {topic} to people who enjoy comfortable public spaces.',
    ],
  },
  routine: {
    transcript: {
    ...
    coreSentences: [
      'I usually follow the same routine for {topic} during a normal weekday.', 'I start by preparing everything I need so I do not waste time later.', 'First, I check my schedule and set a simple goal for that particular day.', 'Then I focus on the most important task while my energy is still high.', 'I normally work without distractions and keep my phone out of reach for a while.', 'After that, I take a short break to clear my head.', 'The break helps me recover my energy and keeps me from feeling overwhelmed.', 'Finally, I check what I have completed and note anything left for tomorrow.', 'This routine keeps me organized during the day.', 'It also helps me feel productive.',
    ],
    nextSentences: [
      'Most of the time, I stick to a regular routine for {topic}.', 'I begin at a similar time because consistency helps me focus throughout the day.', 'Before I start, I prepare the tools and information I need in one place.', 'First, I deal with the task that requires the most attention.', 'Then I move on to smaller and easier steps.', 'I take a short break before I become too tired.', 'During the break, I stretch, get something to drink, and step away from my desk.', 'After that, I return with better concentration.', 'If I am short on time, I simplify a few steps.', 'However, I always try to finish the most important part.', 'At the end, I review the result and plan the next day.', 'Overall, this routine gives my day a clear and comfortable rhythm from start to finish.',
    ],
  },
  past_experience: {
    transcript: {
    ...
    coreSentences: [
      'I remember a special experience involving {topic} that still comes to mind easily.', 'It happened last year when I was with a close friend during an ordinary day.', 'At first, everything went according to plan, and we felt relaxed.', 'Then an unexpected problem suddenly came up without giving us any warning.', 'We were surprised and did not know what to do for the first few moments.', 'After a short discussion, we chose a simple solution that both of us could follow.', 'We worked together to deal with the situation instead of blaming each other.', 'Fortunately, the problem was solved before it got worse.', 'I felt relieved and proud of our decision.', 'The experience taught me to stay calm under pressure.',
    ],
    nextSentences: [
      'One of my most memorable experiences involving {topic} happened last year, and I can still picture it clearly.', 'I had planned the day carefully with a close friend and expected everything to be simple.', 'At the beginning, everything seemed to be going smoothly.', 'Just when we relaxed, an unexpected problem changed the situation.', 'For a moment, both of us felt confused and worried.', 'Instead of panicking, we stopped and discussed our options before making a decision.', 'We divided the tasks and dealt with the most urgent issue first.', 'A stranger also gave us useful advice at the right time.', 'Thanks to that help, we found a practical solution.', 'When everything was finally settled, I felt extremely relieved.', 'Looking back, the event brought my friend and me closer together.', 'It also taught me to stay calm and communicate clearly under pressure.',
    ],
  },
  comparison: {
    transcript: {
    ...
    coreSentences: [
      'There are several differences in {topic} between the past and today, and the contrast is easy to notice.', 'In the past, people had fewer choices and depended on a simpler system.', 'The process was often slower and less convenient for ordinary users.', 'However, the old way felt simple and familiar because everyone understood the basic steps.', 'Today, there are more services and useful tools that solve common problems.', 'Technology has made the process much faster and easier to access.', 'People can choose what fits their needs instead of accepting one standard choice.', 'The biggest improvement is the amount of time people save.', 'Although both versions have advantages, I prefer the current one.', 'It is more convenient for my daily life.',
    ],
    nextSentences: [
      'The way people experience {topic} has changed noticeably over time in ways most people can easily notice.', 'In the past, choices were limited and information was harder to find without much guidance.', 'As a result, people spent more time preparing and waiting before making a decision.', 'Still, the old process was familiar and sometimes felt more personal.', 'Today, technology provides far more options that are easy to compare.', 'Most tasks can be completed quickly with a phone or computer.', 'Modern services can also adapt to different needs.', 'The biggest difference is how convenient the entire process has become.', 'On the other hand, too many choices can occasionally feel overwhelming.', 'For that reason, the older approach still has some charm.', 'Even so, the current system suits my lifestyle better.', 'It saves time every day while giving me the flexibility I need.',
    ],
  },
  role_play: {
    transcript: {
    ...
    coreSentences: [
      'Hello, I am calling about {topic} because I need to make a decision soon.', 'I would like to get some information and choose the right option for my situation.', 'First, could you tell me which options are available for someone in my situation?', 'I would also like to know how much they cost, including any required fees.', 'What times are available this week for a first appointment?', 'Is there a deadline for making a reservation without paying an extra fee?', 'Could you explain the cancellation policy in case my plans change?', 'Is there anything I need to bring or prepare before I arrive?', 'That answers all of my questions.', 'Thank you very much for your help with this important decision.',
    ],
    nextSentences: [
      'Hello, I am calling to get a little more information about {topic}.', 'I am interested, but I would like to compare the available options for my current situation.', 'Could you explain the main difference between the options?', 'I would also appreciate a clear breakdown of the total cost, including taxes and service fees.', 'Are there any additional fees that I should expect?', 'Next, could you tell me which times are still available?', 'I may need to change my schedule, so what is the cancellation policy?', 'Is it possible to make a change online or by phone?', 'I would also like to know what I need to prepare in advance.', 'Let me confirm that I understood the information correctly before making a final decision.', 'That sounds like the best option for my situation.', 'Thank you for answering all of my questions so clearly.',
    ],
  },
  problem_solution: {
    transcript: {
    ...
    coreSentences: [
      'There is a serious problem involving {topic} that needs immediate attention.', 'It is disrupting plans and causing unnecessary stress for everyone directly involved.', 'The first step is to explain the situation clearly so everyone understands what happened.', 'People need accurate information as soon as possible instead of hearing vague promises.', 'A temporary alternative should also be provided while the main issue is investigated.', 'This would reduce the immediate inconvenience and help people continue their plans.', 'Next, the people responsible should find the root cause rather than treating only the symptom.', 'They should create a clear process for similar situations with clear roles and deadlines.', 'That process can prevent the issue from recurring.', 'A combination of quick action and prevention is the best solution.',
    ],
    nextSentences: [
      'The main problem involving {topic} is the lack of preparation and clear communication.', 'Because people do not know what is happening, they feel frustrated and lose time during an already difficult situation.', 'The most urgent step is to share accurate information immediately.', 'A temporary alternative should be offered to the people most affected while a permanent solution is prepared.', 'This short-term response would reduce confusion and inconvenience.', 'At the same time, the organization should identify the root cause.', 'It should speak with the people involved and review the current process.', 'Based on that review, responsibilities and deadlines need to be clarified so everyone knows what happens next.', 'A backup plan should also be prepared in advance.', 'Regular updates would help rebuild trust.', 'These measures could prevent the issue from recurring.', 'In my view, fast communication and long-term prevention must work together.',
    ],
  },
}
